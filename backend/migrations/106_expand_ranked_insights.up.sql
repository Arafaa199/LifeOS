-- Migration 106: Expand insights.get_ranked_insights() from 3 to 8 sources
-- Adds: daily_anomalies, sleep_spend_summary, tv_sleep_summary,
--        productivity_recovery_correlation, sleep_recovery_correlation
-- Adds icon/color fields to jsonb output for iOS rendering
...
COMMENT ON FUNCTION insights.get_ranked_insights IS 'Returns max 3 quality-gated insights from 8 sources, ranked by score. Includes icon/color for iOS rendering.';
