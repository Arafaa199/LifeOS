...
-- Revert migration 158: Remove music from dashboard payload

-- 1. Drop the music summary view
DROP VIEW IF EXISTS life.v_daily_music_summary;

-- 2. Restore dashboard.get_payload() to schema v13 (without music_today)
...
BEGIN
    ...
    -- Build final result (schema_version 13)
...
DELETE FROM ops.schema_migrations WHERE filename = '158_music_dashboard.up.sql';
