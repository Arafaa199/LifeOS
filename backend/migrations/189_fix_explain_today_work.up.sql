...
-- ============================================================================
-- Migration 189: Restore work_minutes to explain_today()
-- Migration 188 (habit streaks) rewrote explain_today() but dropped the work
-- summary section that migration 184 added. This restores it.
-- ============================================================================
...
DECLARE
    ...
    -- Work context (restored from migration 184)
    work_data JSONB;
    work_minutes INT;
    ...
    -- Habit streaks (from migration 188)
    v_habit_rec RECORD;
...
BEGIN
    ...
    -- ── WORK (restored from migration 184) ──────────────────────────────
    ...
    -- ======================================================================
    -- RETURN (v4: v3 habit streaks + restored work_minutes from v2)
    -- ======================================================================
...
COMMENT ON FUNCTION life.explain_today IS 'v4: Restores work_minutes (from v2/migration 184) that was dropped by v3/migration 188. Includes habit streaks + work observations.';

INSERT INTO ops.schema_migrations (filename)
VALUES ('189_fix_explain_today_work.up.sql')
