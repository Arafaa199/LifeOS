...
-- Migration 164: Add mood/energy to dashboard payload
-- Schema version 15

-- Create view for today's mood summary (latest entry)
...
-- Update dashboard.get_payload() to include mood_today (schema v15)
...
BEGIN
    ...
    -- Build final result (schema_version 15: Added mood_today)
...
VALUES ('164_mood_dashboard.up.sql')
