-- Migration 127 DOWN: Revert HRV precision to NUMERIC(5,1)
...
-- Revert column types
ALTER TABLE raw.whoop_cycles ALTER COLUMN hrv TYPE NUMERIC(5,1);
ALTER TABLE normalized.daily_recovery ALTER COLUMN hrv TYPE NUMERIC(5,1);
ALTER TABLE facts.daily_health ALTER COLUMN hrv TYPE NUMERIC(5,1);
ALTER TABLE facts.daily_summary ALTER COLUMN hrv TYPE NUMERIC(5,1);

-- Recreate the view with original types
