-- Rollback: 164_mood_dashboard
-- Restores schema v14 (without mood_today)

DROP VIEW IF EXISTS raw.v_daily_mood_summary;

-- Restore previous get_payload (schema v14 from migration 158)
...
DELETE FROM ops.schema_migrations WHERE filename = '164_mood_dashboard.up.sql';
