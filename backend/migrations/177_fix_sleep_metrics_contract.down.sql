...
-- Rollback: Restore dashboard.get_payload() to v16 (without deep_sleep_minutes, rem_sleep_minutes)
...
DELETE FROM ops.schema_migrations WHERE filename = '177_fix_sleep_metrics_contract.up.sql';
